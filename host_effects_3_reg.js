...
Data.then(function (data) {
    ...
    legend.append('text')
        ...
        .text(function (d, i) {
            switch (i) {
                case 0:
                    return 'E. anglica x nemorosa'
                case 1:
                    return 'E. anglica x rostkoviana'
                case 2:
                    return 'E. arctica'
                case 3:
                    return 'E. arctica x confusa'
                case 4:
                    return 'E. arctica x nemorosa'
                case 5:
                    return 'E. confusa'
                case 6:
                    return 'E. confusa x nemorosa'
                case 7:
                    return 'E. confusa x tetraquetra'
                case 8:
                    return 'E. nemorosa'
                case 9:
                    return 'E. pseudokerneri'
            }
        })
        .attr('font-size', '12px')
